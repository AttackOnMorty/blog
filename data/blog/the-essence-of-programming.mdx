...
There are two important points I want to elaborate on.

#### The Role of Control on Logic
...
It means the `Control only affects the efficiency of the Logic`. For example:
...
- **Logic** and **Control** are the key.
- **Control** only affects the efficiency of **Logic**.
- Why programs are complex?
